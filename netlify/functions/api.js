// This is the backend server code that will run on Netlify
// --- Updated to use ES Modules and a more robust database connection pattern ---
...
// These are your secret keys from Netlify's settings
...
router.use((req, res, next) => {
    if (!mongoURI) {
        console.error('SERVER ERROR: The MONGO_URI environment variable is not set. The database cannot be reached. Please configure this in your Netlify project settings.');
